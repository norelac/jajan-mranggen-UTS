...
<div class="form-card">
    <form action="/penjual/products/update/<?= $product['id'] ?>" method="POST" enctype="multipart/form-data">
        <?= csrf_field() ?>
        <div class="row g-3">
            <div class="col-md-8">
            ...
            <div class="col-md-6">
                <label class="form-label">Foto Baru <small class="text-muted">(kosongkan jika tidak diubah)</small></label>
        ...
        <div class="d-flex gap-3">
            <button type="submit" class="btn btn-primary-custom px-4"><i class="fas fa-save me-2"></i>Perbarui Produk</button>
